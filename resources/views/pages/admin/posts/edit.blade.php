...
@section('content')
    @include('pages.admin.users.partials.header', ['title' => __('Edit post')])   
                        ...
                        <form method="POST" action="{{ route('post.update', [$post->id]) }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('title') }}" value="{{ $post->title }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('body') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="body" id="" cols="30" rows="10" class="d-block w-100 form-control @error('body') is-invalid @enderror">{{ $post->body }}</textarea>
